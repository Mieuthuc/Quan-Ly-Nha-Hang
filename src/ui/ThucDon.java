...
public class ThucDon extends javax.swing.JFrame {
    ...
    public ThucDon() {
     ...
     void setColor() {
        tbl.setBackground(XColor.color);
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Món Ăn", pnlMonAn);
        ...
        pnlThucUongLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlThucUongLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(pnlThucUongLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jTabbedPane1.addTab("Thức Uống", pnlThucUong);
        ...
        tbl.setBackground(new java.awt.Color(255, 255, 204));
        tbl.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(255, 255, 204)));
        tbl.setFloatable(false);
        tbl.setForeground(new java.awt.Color(255, 255, 255));
        tbl.setRollover(true);
        tbl.setToolTipText("");
        tbl.setBorderPainted(false);
    ...
    private void btnXemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemActionPerformed
        int index = QLThongKe.getIndex(tblThucDon);
        if (index >= 0) {
            Entity.monAn = QLMonAn.dao.selectByName((String) tblThucDon.getValueAt(index, 0));
            if (!Auth.isManager()) {
                this.openThemMoi(1);
            } else {
                this.openThemMoi(2);
